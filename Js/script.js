...
function showDedicationText() { //seguidores
  ...
  if (!text) {
   ...
   you owe me a night of passion. Bye 😉`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, YO, tu Dulce Amor";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2014-07-17T00:00:00'); 
  let startDateMarried = startParam ? new Date(startParam + 'T00:00:00') : new Date('2022-01-22T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2027-01-22T00:00:00');

  function update() {
    const now = new Date();
    let diff = now - startDate;
    let diffMarried = now - startDateMarried;
    ...
    container.innerHTML =
      ...
      `Nuestro aniversario: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b> <br>`  + 
      `Llevamos Casados: <b>${daysMarried}</b> días`;
